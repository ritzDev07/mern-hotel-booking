...
test("should edit hotel", async ({ page }) => {
    ...
    await expect(page.locator('[name="name"]')).toHaveValue("My Hotels");
    await page.locator('[name="name"]').fill("My Hotels UPDATED");
    await page.getByRole("button", { name: "Save" }).click();
    await expect(page.getByText("Hotel Saved!")).toBeVisible();
    ...
    await page.locator('[name="name"]').fill("My Hotels");
    await page.getByRole("button", { name: "Save" }).click();
});